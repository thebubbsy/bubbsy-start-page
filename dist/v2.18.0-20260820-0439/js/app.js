...
<body>
  ...
  document.getElementById('btn-geo-copy-maps-url')?.addEventListener('click', () => {
    const url = `https://www.google.com/maps?q=${currentResolvedCoords.lat},${currentResolvedCoords.lon}`;
    navigator.clipboard.writeText(url);
    showToast(`Copied Google Maps Deep Link: ${url}`);
  });
