...
(function () {
  ...
  const BUNDLED_OFFLINE_RADAR_ADVISORIES = [
    { id: 'CVE-2026-1184', title: 'Fortinet FortiClient Remote Code Execution Zero-Day', severity: 'CRITICAL', vendor: 'Fortinet', date: '2026-02-18', ransomware: true, description: 'Heap-based buffer overflow allowing remote unauthenticated code execution in SSL-VPN handler.', url: 'https://nvd.nist.gov/vuln/detail/CVE-2026-1184' },
    { id: 'CVE-2026-21417', title: 'Ivanti Connect Secure Authentication Bypass', severity: 'CRITICAL', vendor: 'Ivanti', date: '2026-02-10', ransomware: true, description: 'Authentication bypass flaw actively exploited in the wild targeting government and defense gateways.', url: 'https://nvd.nist.gov/vuln/detail/CVE-2026-21417' },
    { id: 'ACSC-2026-004', title: 'ACSC Alert: Crucial Multi-Factor Authentication Enforcement Guidance', severity: 'HIGH', publisher: 'Australian Cyber Security Centre', date: '2026-01-28', essential_eight_pillar: 'Multi-Factor Authentication (ML3)', description: 'Mandatory technical implementation instructions for phish-resistant FIDO2 MFA across all corporate cloud tenancies.', url: 'https://www.cyber.gov.au/about-us/advisories' },
    { id: 'CVE-2026-0852', title: 'Palo Alto PAN-OS Command Injection Vulnerability', severity: 'CRITICAL', vendor: 'Palo Alto Networks', date: '2026-01-20', ransomware: false, description: 'Root-level command execution vulnerability in management web interface.', url: 'https://nvd.nist.gov/vuln/detail/CVE-2026-0852' },
    { id: 'ACSC-2026-002', title: 'Essential Eight Maturity Model 2026 Hardening Directive', severity: 'HIGH', publisher: 'ASD Cyber Security', date: '2026-01-15', essential_eight_pillar: 'Application Control & Patching', description: 'Updated technical guidance on restricting unapproved binary execution and script interpreters.', url: 'https://www.cyber.gov.au/essential-eight' },
    { id: 'CVE-2025-21418', title: 'Microsoft Exchange Remote Code Execution (Active KEV)', severity: 'CRITICAL', vendor: 'Microsoft', date: '2025-12-14', ransomware: true, description: 'Chained deserialization flaw allowing SYSTEM compromise via malicious SMTP payload.', url: 'https://nvd.nist.gov/vuln/detail/CVE-2025-21418' }
  ];
  ...
  async function fetchThreatRadarFeed(feedType = activeRadarFeed) {
    ...
    try {
      ...
      radarFeedData = BUNDLED_OFFLINE_RADAR_ADVISORIES;
      const badge = document.getElementById('radar-live-badge');
