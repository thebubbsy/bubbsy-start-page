...
(function () {
  ...
  function renderWorldClocks() {
    const clocks = (appData.world_clocks && appData.world_clocks.length >= 6) ? appData.world_clocks : DEFAULT_WORLD_CLOCKS;
    elWorldClocks.innerHTML = clocks.map(c => `
      <div class="clock-item" data-tz="${c.timezone}" data-name="${escapeHtml(c.name)}" title="Click to copy ISO timestamp" style="cursor:pointer;">
