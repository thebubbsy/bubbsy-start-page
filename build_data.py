    ...
    aus_widgets = [
        ...
        },
        {
            ...
            'links': [
                ...
                {'title': 'Transport WA Vehicle Licence (Rego) Check', 'url': 'https://www.wa.gov.au/service/transport/road-transport/check-your-vehicle-licence-rego-expiry-date', 'description': 'Free WA vehicle licence (rego) status and expiry lookup by plate number', 'domain': 'wa.gov.au', 'favicon': 'https://f.start.me/wa.gov.au'},
                {'title': 'EzyReg SA Vehicle Registration Check', 'url': 'https://www.ecom.transport.sa.gov.au/et/checkRegistrationExpiryDate.do', 'description': 'Free South Australian vehicle registration expiry and CTP insurer lookup by plate number', 'domain': 'transport.sa.gov.au', 'favicon': 'https://f.start.me/transport.sa.gov.au'},
